...
printf "Running tests map bounded buffer, chained (calculator + sink)\n"
...
do
    ...
    do
        ...
        ./main --nsource $nsource --nmatcher $nmatch --ncalculator 1 --nsink 1 --rate 10000 | tee ../tests/output_60s_map_bounded_chained/main_$nsource-$nmatch-1-1-10000.log
    done
done
