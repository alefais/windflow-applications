...
struct result_t {
    ...
    string states;           // representation of the transaction sequence
    size_t key;              // key
    uint64_t id;             // id
    ...
    // constructor
    result_t(const string& _entity_id, double_t _score, const string& _states, size_t _key, uint64_t _id, uint64_t _ts) :
